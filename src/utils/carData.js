export const carData = [
  ...
  { image: 8, x: 30, y: 60, title: "the tire", detail: "tire" },
  { image: 9, x: 40, y: 50, title: "the door front", detail: "door-front" },
  { image: 10, x: 40, y: 40, title: "the car in", detail: "door-front" },
  { image: 11, x: 70, y: 60, title: "the hood", detail: "door-front" },
